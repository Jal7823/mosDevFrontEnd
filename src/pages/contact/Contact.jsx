      ...
      <div className="my-auto min-w-[50%]">
        <form onSubmit={handleSubmit(onSubmit)} className="flex justify-center mx-auto flex-col m-4 w-1/2 rounded">
          <div className="flex justify-around p-4">
            <input {...register('name')} className="border-2 w-full m-4 rounded p-2" type="text" placeholder="Nombre Completo" />
            <input {...register('email')} className="border-2 w-full ml-2 rounded p-2" type="email" placeholder="Email" />
          </div>
          <input {...register('case')} className="w-100 border-2 p-2 m-4 rounded" type="text" placeholder="Asunto" />
